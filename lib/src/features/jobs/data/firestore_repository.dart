...
import 'package:clean_arch_riverpod_firebase/src/features/jobs/data/firestore_data_source.dart';
...
String documentIdFormCurrentDate() {
...
final jobEntriesStreamProvider =
  ...
  final user = ref.watch(authStateChangesProvider).value;
  if (user == null) {
    throw AssertionError('Can\'t be null when fetching jobs');
  }
  final database = ref.watch(databaseProvider);
